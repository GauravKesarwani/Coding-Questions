...
public class StringEx1 {
    ...
    public static void main(String[] args) {
        System.out.println("Output for replaceAllChar(): " + repalceAllChar("gauravkesarwani", "a" , ""));
        ...
        System.out.println("Output for char:"+ "saurabhkesarwani".replaceAll("a", ""));
        System.out.println("Output for char:"+ "saurabhkesarwani".replace("a", ""));
        System.out.println("Output for delete all non digit:"+ "23%#2&12".replace("%#", ""));
    }
