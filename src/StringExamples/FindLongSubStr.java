...
public class FindLongSubStr {
    ...
    public Set<String> getLongestSubstr(String input){
        ...
        for (int i = 0; i < inputCharArr.length; i++) {
            ...
            if (flag[c]) {
                System.out.println(extractSubString(inputCharArr,j,i));
                for (int k = j; k < i; k++) {
                    if (inputCharArr[k] == c) {
                        j = k + 1;
                        System.out.println("inputCharArr[k] " +inputCharArr[k] );
                        break;
                    }
    ...
    public static void main(String a[]){
        FindLongSubStr mls = new FindLongSubStr();
